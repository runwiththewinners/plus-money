    ...
    >
      ...
      <div style={{ padding: "20px 24px" }}>
        ...
        >
          ...
          >
            Premium & High Roller members get all plus money plays
          </div>
          <button
    ...
    >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                {hasPremiumAccess || isAdmin
                  ...
                  : "New plus money play dropped! Upgrade to view"}
              </div>
            </div>
            <button
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: "#f5f5f5" }}>Plus</span>
            <br />
            <span
              style={{
                color: "#d4a843",
          ...
          >
            Every plus money play, posted live.
          </p>
        </div>
              ...
              {pendingPlays.length === 0 ? (
                ...
                <div style={{ textAlign: 'center', padding: '40px 20px' }}>
                  ...
                  <div style={{ fontSize: 12, color: '#4b5563', fontFamily: "'Courier Prime', monospace", lineHeight: 1.6, marginBottom: 28, maxWidth: 320, margin: '0 auto 28px' }}>
                    Upgrade to Premium or High Rollers to unlock all Plus Money picks and full bet slip access.
                  </div>
